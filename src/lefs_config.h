...
#ifndef LEFS_CONFIG_H
#define LEFS_CONFIG_H
...
// #define LEFS_NO_DEBUG
// #define LEFS_NO_WARN
// #define LEFS_NO_ERROR
// #define LEFS_NO_ASSERT

#if MODULE_FUNCTION == MOD_FUNC_BOOTLOADER
#define LEFS_NO_MALLOC
#else
#include <stdlib.h>
...
#include "logging.h"
#endif /* !defined(LEFS_NO_DEBUG) && !defined(LEFS_NO_WARN) && !defined(LEFS_NO_ERROR) */

#ifndef LEFS_NO_DEBUG
#define LEFS_DEBUG(fmt, ...) LOG_DEBUG(TRACE, fmt, __VA_ARGS__)
#else
#define LEFS_DEBUG(fmt, ...)
#endif /* LEFS_NO_DEBUG */

#ifndef LEFS_NO_WARN
#define LEFS_WARN(fmt, ...) LOG_DEBUG(WARN, fmt, __VA_ARGS__)
#else
#define LEFS_WARN(fmt, ...)
#endif /* LEFS_NO_WARN */

#ifndef LEFS_NO_ERROR
#define LEFS_ERROR(fmt, ...) LOG_DEBUG(ERROR, fmt, __VA_ARGS__)
#else
...
#define LEFS_ASSERT(test) SPARK_ASSERT(test)
#else
#define LEFS_ASSERT(test)
#endif /* LEFS_NO_ASSERT */
